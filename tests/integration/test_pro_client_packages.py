...
def test_integration_pro_packages_v1_default(jamf_client):
    ...
    result_one_call = jamf_client.pro_api.get_packages_v1()
    ...
    result_paginated = jamf_client.pro_api.get_packages_v1(page_size=10)
