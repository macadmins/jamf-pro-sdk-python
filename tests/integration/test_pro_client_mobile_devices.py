...
def test_integration_pro_computer_inventory_v1_default(jamf_client):
    ...
    result_one_call = jamf_client.pro_api.get_mobile_device_inventory_v2(page_size=2000)
    ...
    result_paginated = jamf_client.pro_api.get_mobile_device_inventory_v2(page_size=10)
